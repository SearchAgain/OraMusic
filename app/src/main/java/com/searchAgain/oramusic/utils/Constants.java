...
public class Constants {
    ...
    public static final String ORA_MUSIC1 = "oramusic1";
    public static final String ORA_MUSIC2 = "oramusic2";
    public static final String ORA_MUSIC3 = "oramusic3";
    public static final String ORA_MUSIC4 = "oramusic4";
    public static final String ORA_MUSIC5 = "oramusic5";
    public static final String ORA_MUSIC6 = "oramusic6";
