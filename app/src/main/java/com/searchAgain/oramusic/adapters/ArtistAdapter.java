...
public class ArtistAdapter extends RecyclerView.Adapter<ArtistAdapter.ItemHolder> implements BubbleTextGetter {
    ...
    public void onBindViewHolder(final ItemHolder itemHolder, int i) {
        ...
        String albumNmber = oramusicUtils.makeLabel(mContext, R.plurals.Nalbums, localItem.albumCount);
        String songCount = oramusicUtils.makeLabel(mContext, R.plurals.Nsongs, localItem.songCount);
        itemHolder.albums.setText(oramusicUtils.makeCombinedString(mContext, albumNmber, songCount));
