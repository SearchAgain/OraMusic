...
package com.searchAgain.oramusic;
...
import com.searchAgain.oramusic.helpers.MediaButtonIntentReceiver;
import com.searchAgain.oramusic.helpers.MusicPlaybackTrack;
import com.searchAgain.oramusic.lastfmapi.LastFmClient;
import com.searchAgain.oramusic.lastfmapi.models.LastfmUserSession;
import com.searchAgain.oramusic.lastfmapi.models.ScrobbleQuery;
import com.searchAgain.oramusic.permissions.Nammu;
import com.searchAgain.oramusic.permissions.PermissionCallback;
import com.searchAgain.oramusic.provider.MusicPlaybackState;
...
import com.searchAgain.oramusic.utils.oramusicUtils.IdType;
import com.searchAgain.oramusic.widgets.MusicVisualizer;
import com.nostra13.universalimageloader.core.ImageLoader;
import com.nostra13.universalimageloader.utils.L;
import com.searchAgain.oramusic.IoramusicService;
...
public class MusicService extends Service {
    public static final String PLAYSTATE_CHANGED = "com.searchAgain.oramusic.playstatechanged";
    public static final String POSITION_CHANGED = "com.searchAgain.oramusic.positionchanged";
    public static final String META_CHANGED = "com.searchAgain.oramusic.metachanged";
    public static final String QUEUE_CHANGED = "com.searchAgain.oramusic.queuechanged";
    public static final String PLAYLIST_CHANGED = "com.searchAgain.oramusic.playlistchanged";
    public static final String REPEATMODE_CHANGED = "com.searchAgain.oramusic.repeatmodechanged";
    public static final String SHUFFLEMODE_CHANGED = "com.searchAgain.oramusic.shufflemodechanged";
    public static final String TRACK_ERROR = "com.searchAgain.oramusic.trackerror";
    public static final String oramusic_PACKAGE_NAME = "com.searchAgain.oramusic";
    public static final String MUSIC_PACKAGE_NAME = "com.android.music";
    public static final String SERVICECMD = "com.searchAgain.oramusic.musicservicecommand";
    public static final String TOGGLEPAUSE_ACTION = "com.searchAgain.oramusic.togglepause";
    public static final String PAUSE_ACTION = "com.searchAgain.oramusic.pause";
    public static final String STOP_ACTION = "com.searchAgain.oramusic.stop";
    public static final String PREVIOUS_ACTION = "com.searchAgain.oramusic.previous";
    public static final String PREVIOUS_FORCE_ACTION = "com.searchAgain.oramusic.previous.force";
    public static final String NEXT_ACTION = "fcom.searchAgain.oramusic.next";
    public static final String REPEAT_ACTION = "com.searchAgain.oramusic.repeat";
    public static final String SHUFFLE_ACTION = "com.searchAgain.oramusic.shuffle";
    public static final String FROM_MEDIA_BUTTON = "frommediabutton";
    public static final String REFRESH = "com.searchAgain.oramusic.refresh";
    public static final String UPDATE_LOCKSCREEN = "com.searchAgain.oramusic.updatelockscreen";
    ...
    private static final boolean D = /*false;//*/true;  //develop ongoing
    private static final String SHUTDOWN = "com.searchAgain.oramusic.shutdown";
    ...
    private byte[] mBytes=new byte[CAPTURE_SIZE];
    ...
    public boolean onUnbind(final Intent intent) {
        ...
        mServiceInUse = false;
        if(visualiser!=null)visualiser.setEnabled(false);
        saveQueue(true);
    ...
    public void onRebind(final Intent intent) {
        cancelShutdown();
        mServiceInUse = true;
        if(visualiser!=null)visualiser.setEnabled(true);
    ...
    private boolean doesUserHavePermission()
    {
       ...
       //     ActivityCompat.requestPermissions((Activity) getApplicationContext(), new String[]{Manifest.permission.RECORD_AUDIO},101);
       // } else {
      //     if(D) Log.i(TAG,"Storage Permission granted");
//
      //  }
        if(D) Log.i(TAG,"Storage Permission ------------------>"+permissionCheck);
            ...
            if(doesUserHavePermission()){
                {
                    ...
                    visualiser = new Visualizer(getAudioSessionId());
                    if (D) Log.i(TAG, "setting visualizer data source-->"+getAudioSessionId());
                    visualiser.setDataCaptureListener(new Visualizer.OnDataCaptureListener()
                    {
                        ...
                        public void onWaveFormDataCapture(Visualizer visualizer, byte[] bytes,
                                                          int samplingRate)
                        {
                            // if (D) Log.i(TAG,  "------ trying to change visualizer data ------");
                            setmBytes(bytes);
                        }
                        @Override
    ...
    private void setUpMediaSession() {
        mSession = new MediaSessionCompat(this, "oramusic");
    ...
    public void onDestroy() {
        ...
        super.onDestroy();
        if(visualiser!=null)visualiser.release();
        visualiser=null;
        //Try to push LastFMCache
        ...
        if (oramusicUtils.isJellyBeanMR2())
    ...
    private int getCardId() {
        if (oramusicUtils.isMarshmallow()) {
    ...
    private void addToPlayList(final long[] list, int position, long sourceId, oramusicUtils.IdType sourceType) {
    ...
    private void doAutoShuffleUpdate() {
        ...
        for (int i = 0; i < toAdd; i++) {
            ...
            mPlaylist.add(new MusicPlaybackTrack(mAutoShuffleList[idx], -1, oramusicUtils.IdType.NA, -1));
            notify = true;
        }
        if (notify) {
            notifyChange(QUEUE_CHANGED);
    ...
    private void notifyChange(final String what) {
        ...
        musicIntent.setAction(what.replace(oramusic_PACKAGE_NAME, MUSIC_PACKAGE_NAME));
        ...
        if (mRemoteControlClient != null) {
            ...
            if (what.equals(META_CHANGED) || what.equals(QUEUE_CHANGED)) {
                ...
                if (mShowAlbumArtOnLockscreen) {
                    albumArt = ImageLoader.getInstance().loadImageSync(oramusicUtils.getAlbumArtUri(getAlbumId()).toString());
                    if (albumArt != null) {
    ...
    private Notification buildNotification() {
        ...
        Bitmap artwork;
        artwork = ImageLoader.getInstance().loadImageSync(oramusicUtils.getAlbumArtUri(getAlbumId()).toString());
        ...
        if (oramusicUtils.isJellyBeanMR1()) {
        ...
        if (artwork != null && oramusicUtils.isLollipop())
                ...
                do {
                    TrackItem t = new TrackItem()
                            .setArt(ImageLoader.getInstance()
                                    .loadImageSync(oramusicUtils.getAlbumArtUri(c.getLong(c.getColumnIndexOrThrow(AudioColumns.ALBUM_ID))).toString()))
                            ...
                            .setDuration(oramusicUtils.makeShortTimeString(this, c.getInt(c.getColumnIndexOrThrow(AudioColumns.DURATION)) / 1000));
                    list.add(t.get());
                } while (c.moveToNext());
                try {
                ...
                try {
                    if (mCursor != null && shouldAddToPlaylist) {
                        ...
                        mPlaylist.add(new MusicPlaybackTrack(
                                mCursor.getLong(IDCOLIDX), -1, oramusicUtils.IdType.NA, -1));
                        notifyChange(QUEUE_CHANGED);
                        mPlayPos = 0;
                        mHistory.clear();
                    }
    ...
    public void open(final long[] list, final int position, long sourceId, oramusicUtils.IdType sourceType) {
        synchronized (this) {
            if (mShuffleMode == SHUFFLE_AUTO) {
    ...
    public void play(boolean createNewNextTrack) {
        ...
        if(visualiser==null){
        if(doesUserHavePermission()){
            if(visualiser==null)startVisualiser();
            visualiser.setEnabled(true);
        }}
...
//////over multiplayer
    private static final class ServiceStub extends IoramusicService.Stub {
    ...
    @Override
    public byte[] getmBytes() {
        return mService.get().getmBytes();
    }

    @Override
    public void setmBytes(byte[] mBytes) {
        mService.get().setmBytes(mBytes);
    }
