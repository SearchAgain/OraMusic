...
package com.searchAgain.oramusic.subfragments;
...
import com.searchAgain.oramusic.activities.DonateActivity;
...
public class SubStyleSelectorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                styleImage.setImageResource(R.drawable.oramusic_1_nowplaying_x);
                break;
            case 1:
                styleImage.setImageResource(R.drawable.oramusic_2_nowplaying_x);
                break;
            case 2:
                styleImage.setImageResource(R.drawable.oramusic_3_nowplaying_x);
                break;
            case 3:
                styleImage.setImageResource(R.drawable.oramusic_4_nowplaying_x);
                break;
            case 4:
                styleImage.setImageResource(R.drawable.oramusic_5_nowplaying_x);
                break;
            case 5:
                styleImage.setImageResource(R.drawable.oramusic_6_nowplaying_x);
                break;
        }
    ...
    public void setCurrentStyle() {
        String fragmentID = preferences.getString(Constants.NOWPLAYING_FRAGMENT_ID, Constants.ORA_MUSIC3);
    ...
    private String getStyleForPageNumber() {
        switch (getArguments().getInt(ARG_PAGE_NUMBER)) {
            case 0:
                return Constants.ORA_MUSIC1;
            case 1:
                return Constants.ORA_MUSIC2;
            case 2:
                return Constants.ORA_MUSIC3;
            case 3:
                return Constants.ORA_MUSIC4;
            case 4:
                return Constants.ORA_MUSIC5;
            case 5:
                return Constants.ORA_MUSIC6;
            default:
                return Constants.ORA_MUSIC3;
        }
    }
