...
import com.searchAgain.oramusic.utils.ImageUtils;
...
public class QuickControlsFragment extends Fragment implements MusicStateListener {
    ...
    public void updateNowplayingCard() {
        ...
        if (!duetoplaypause) {
            ImageLoader.getInstance().displayImage(oramusicUtils.getAlbumArtUri(MusicPlayer.getCurrentAlbumId()).toString(), mAlbumArt,
