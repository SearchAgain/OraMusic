...
public class MusicPlayer {
    ...
    public static IoramusicService mService = null;
    ...
    public static byte[] getmBytes() {
        try {
            return mService.getmBytes();
        } catch (final RemoteException ignored) {
        }
    ...
    public static void setmBytes(byte[] mBytes) {
        try {
            mService.setmBytes(mBytes);
        } catch (final RemoteException ignored) {
        }
    ...
    public static final int getAudioSessionId() {
        ...
        if (mService != null) {
            try {
                Log.d("mm4", "getAudioSessionId-->"+mService.getAudioSessionId());
    ...
    public static final class ServiceBinder implements ServiceConnection {
        ...
        public void onServiceConnected(final ComponentName className, final IBinder service) {
            mService = IoramusicService.Stub.asInterface(service);
            if (mCallback != null) {
