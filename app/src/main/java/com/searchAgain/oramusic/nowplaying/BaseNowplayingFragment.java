...
import com.searchAgain.oramusic.activities.BaseActivity;
import com.searchAgain.oramusic.adapters.BaseQueueAdapter;
import com.searchAgain.oramusic.adapters.SlidingQueueAdapter;
import com.searchAgain.oramusic.dataloaders.QueueLoader;
import com.searchAgain.oramusic.listeners.MusicStateListener;
import com.searchAgain.oramusic.timely.TimelyView;
import com.searchAgain.oramusic.utils.Helpers;
import com.searchAgain.oramusic.utils.PreferencesUtility;
import com.searchAgain.oramusic.utils.SlideTrackSwitcher;
import com.searchAgain.oramusic.utils.oramusicUtils;
import com.searchAgain.oramusic.widgets.CircularSeekBar;
import com.searchAgain.oramusic.widgets.DividerItemDecoration;
import com.searchAgain.oramusic.widgets.PlayPauseButton;
import com.searchAgain.oramusic.widgets.PlayPauseDrawable;
...
public class BaseNowplayingFragment extends Fragment implements MusicStateListener {
        ...
        public void run() {
            ...
            if (mProgress != null) {
                ...
                if (elapsedtime != null && getActivity() != null)
                    elapsedtime.setText(oramusicUtils.makeShortTimeString(getActivity(), position / 1000));
            }
            overflowcounter--;
    ...
    public Runnable mUpdateElapsedTime = new Runnable() {
        ...
        public void run() {
            if (getActivity() != null) {
                String time = oramusicUtils.makeShortTimeString(getActivity(), MusicPlayer.position() / 1000);
                if (time.length() < 5) {
    ...
    public void setSongDetails(View view) {
        ...
        if (playPauseFloating != null) {
            playPauseDrawable.setColorFilter(oramusicUtils.getBlackWhiteColor(accentColor), PorterDuff.Mode.MULTIPLY);
    ...
    public void updateSongDetails() {
        ...
        if (songduration != null && getActivity() != null)
            songduration.setText(oramusicUtils.makeShortTimeString(getActivity(), MusicPlayer.duration() / 1000));
