...
public class DonateActivity extends BaseThemedActivity implements BillingProcessor.IBillingHandler {
    ...
    private static final String DONATION_1 = "searchAgain.oramusic.donate_1";
    private static final String DONATION_2 = "searchAgain.oramusic.donate_2";
    private static final String DONATION_3 = "searchAgain.oramusic.donate_3";
    private static final String DONATION_5 = "searchAgain.oramusic.donate_5";
    private static final String DONATION_10 = "searchAgain.oramusic.donate_10";
    private static final String DONATION_20 = "searchAgain.oramusic.donate_20";
