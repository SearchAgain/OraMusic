...
import com.searchAgain.oramusic.subfragments.QuickControlsFragment;
...
import static com.searchAgain.oramusic.MusicPlayer.mService;
...
public class BaseActivity extends ATEActivity implements ServiceConnection, MusicStateListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if (!oramusicUtils.hasEffectsPanel(BaseActivity.this)) {
